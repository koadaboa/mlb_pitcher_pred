...
class StrikeoutModelConfig:
    ...
    PITCHER_ROLLING_COLS = [
        ...
        "sinker_whiff_rate",
        "splitter_whiff_rate",
        "whiff_rate_zone_high_inside",
        "whiff_rate_zone_high_middle",
        "whiff_rate_zone_high_outside",
        "whiff_rate_zone_middle_inside",
        "whiff_rate_zone_middle_middle",
        "whiff_rate_zone_middle_outside",
        "whiff_rate_zone_low_inside",
        "whiff_rate_zone_low_middle",
        "whiff_rate_zone_low_outside",
        "avg_release_speed",
        "max_release_speed",
        "avg_spin_rate",
        "hard_hit_rate",
